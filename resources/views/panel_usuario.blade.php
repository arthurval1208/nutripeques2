...
<div class="container py-5">
    ...
    <div class="card-grid">
        ...
        <a href="{{ url('/inicio') }}" class="dashboard-card">
            <i class="bi bi-house-heart-fill"></i>
            <h5>Ir al Inicio</h5>
        </a>
        <a href="{{ route('hijos.registrados') }}" class="dashboard-card">
            <i class="bi bi-people-fill"></i>
            <h5>Mis Hijos Registrados</h5>
        </a>

        <!-- Nueva card para agregar un hijo -->
        <a href="{{ url('/agregar_hijo') }}" class="dashboard-card">
